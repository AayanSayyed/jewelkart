...
<div class="container w3-animate-opacity">
    ...
    <div class="product-details">
        <div>
            ...
            <?php if($product['name'] == 'Twinkle Berry Diamond Necklace'): ?>
                <p class="prod-description">
A stunning diamond necklace that exudes sophistication and grace. The Twinkle Berry Diamond Necklace features a delicately crafted design with sparkling diamonds that catch the light from every angle. Perfect for weddings, formal events, or special celebrations, this necklace rests comfortably on the neckline, highlighting elegance and charm. Available in adjustable lengths, it complements any attire while radiating timeless beauty. A piece designed to make every moment unforgettable.
