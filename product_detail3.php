...
<div class="container w3-animate-opacity">
    ...
    <div class="product-details">
        <div>
            ...
            <?php if($product['name'] == 'Radiance Royale Solitaire Ring'): ?>
                <p class="prod-description">
An exquisite solitaire ring that embodies luxury and refined elegance. Perfect for proposals, anniversaries, or special occasions, the Radiance Royale Solitaire Ring dazzles with a brilliant-cut central diamond that captures every ray of light. The sleek, polished band enhances the gemstone’s radiance while ensuring a comfortable fit for sizes 5 to 10 (US). This ring combines timeless charm with modern sophistication, making it a treasured piece to celebrate life’s most precious moments.
